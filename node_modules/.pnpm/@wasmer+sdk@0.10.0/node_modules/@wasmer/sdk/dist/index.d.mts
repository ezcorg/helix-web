...
interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__hfb6dcc958bdf22f8: (a: number, b: number) => void;
  readonly closure651_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure875_externref_shim: (a: number, b: number) => any;
  readonly closure876_externref_shim: (a: number, b: number, c: any) => number;
  readonly closure1532_externref_shim_multivalue_shim: (a: number, b: number, c: any) => [number, number, number];
  readonly closure1533_externref_shim_multivalue_shim: (a: number, b: number, c: any) => [number, number];
